  ...
  useEffect(() => {
    ...
    script.innerHTML = `
      ...
      (function() {
          ...
          const _0x4e2a = ['src', 'chatbot-frame', 'setAttribute', 'data-provider', 'addEventListener', 'DOMContentLoaded', 'getElementById', 'https://cloud.outhad.com/chatbot/f3AsP40F44L0Rog1', 'loading-screen', 'style', 'display', 'none'];
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full">
      ...
      <div className="iframe-container">
        ...
        {/* The iframe with no src initially - will be set by JavaScript */}
        <iframe
          id="chatbot-frame"
          frameBorder="0"
          allow="microphone"
        ...
        <div className="footer-overlay">
          <div className="custom-footer">
            {/* <img src="https://kiet.edu/assets/img/fav.png" alt="KIET Logo" /> */}
