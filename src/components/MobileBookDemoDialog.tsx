...
interface MobileBookDemoDialogProps {
  isOpen: boolean;
  onClose: () => void;
}

export function MobileBookDemoDialog({ isOpen, onClose }: MobileBookDemoDialogProps) {
  return (
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            {/* Header with title and close button */}
                <div className="sticky top-0 h-14 bg-white border-b border-gray-100 flex items-center justify-between px-4">
                  <h2 className="text-base font-medium text-gray-900">Book a Demo</h2>
              <button
                onClick={onClose}
